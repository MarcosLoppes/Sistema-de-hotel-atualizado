...
public class suites3 {
    ...
    public static void suiteSupreme(){
        
        while(true){
            System.out.println();
            System.out.println("---- Suite Supreme ----");
            System.out.println();
    ...
    public static void exibirReserva(){
        ...
        for (i = 0; i < quarto.length; i++) {
            if (quarto[i] == true) {
                System.out.println("Quarto " + (i + 21) + ": Ocupado por " + reservas.get(i + 1));
            } else {
                System.out.println("Quarto " + (i + 21) + ": Disponivel");
            }
        }
    }
    ...
    public static void fazerReserva() {
        ...
        while(x){
            ...
            var numeroQuarto = lerDados.lerInt() - 20;
      
            if (numeroQuarto < 1 || numeroQuarto > 10) {
                System.out.println("Numero de quarto invalido. Por favor, digite um numero de 21 a 30.");
                ...
                System.out.println();
                System.out.println("Quarto " + (numeroQuarto + 20) + " reservado para " + nome);
    ...
    public static void lista3(){
        System.out.println();
        System.out.println("----- Reservas de Quartos Supreme -----");
        for (Map.Entry<Integer, String> reserva : reservas.entrySet()) {
            System.out.println("Quarto numero " + (reserva.getKey() + 20) + " ocupado por " + reserva.getValue());
        }
    }
}
